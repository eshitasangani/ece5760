	Computer_System u0 (
		...
		.pio_ci_step_external_connection_export    (<connected-to-pio_ci_step_external_connection_export>),    //    pio_ci_step_external_connection.export
		.pio_cr_step_external_connection_export    (<connected-to-pio_cr_step_external_connection_export>),    //    pio_cr_step_external_connection.export
		.pio_reset_full_external_connection_export (<connected-to-pio_reset_full_external_connection_export>), // pio_reset_full_external_connection.export
		.pio_done_done_external_connection_export  (<connected-to-pio_done_done_external_connection_export>)   //  pio_done_done_external_connection.export
	);
