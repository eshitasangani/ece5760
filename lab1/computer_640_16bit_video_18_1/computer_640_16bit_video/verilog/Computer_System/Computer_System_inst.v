	Computer_System u0 (
		...
		.pio_beta_external_connection_export             (<connected-to-pio_beta_external_connection_export>),             //        pio_beta_external_connection.export
		.pio_clk_external_connection_export              (<connected-to-pio_clk_external_connection_export>),              //         pio_clk_external_connection.export
		...
		.pio_rho_external_connection_export              (<connected-to-pio_rho_external_connection_export>),              //         pio_rho_external_connection.export
		.pio_sigma_external_connection_export            (<connected-to-pio_sigma_external_connection_export>),            //       pio_sigma_external_connection.export
		.pio_x_i_external_connection_export              (<connected-to-pio_x_i_external_connection_export>),              //         pio_x_i_external_connection.export
		.pio_x_o_external_connection_export              (<connected-to-pio_x_o_external_connection_export>),              //         pio_x_o_external_connection.export
		.pio_y_i_external_connection_export              (<connected-to-pio_y_i_external_connection_export>),              //         pio_y_i_external_connection.export
		.pio_y_o_external_connection_export              (<connected-to-pio_y_o_external_connection_export>),              //         pio_y_o_external_connection.export
		.pio_z_i_external_connection_export              (<connected-to-pio_z_i_external_connection_export>),              //         pio_z_i_external_connection.export
		.pio_z_o_external_connection_export              (<connected-to-pio_z_o_external_connection_export>),              //         pio_z_o_external_connection.export
